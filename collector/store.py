...
def _business_context(task_id: str, scenario: str) -> dict[str, Any]:
    ...
    context["department_agent"] = context.get("department_agent") or "当前通用 Agent"
